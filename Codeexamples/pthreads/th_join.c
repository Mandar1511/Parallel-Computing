...
******************************************************************************/
//compile this code with the command: gcc -pthread th_join.c -lm
#include <pthread.h>
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
int main (int argc, char *argv[])
{
   ...
   pthread_attr_t attr; /*step 1 */
   int rc;
   long t;
   void *status;

   /* Initialize and set thread detached attribute */
   pthread_attr_init(&attr); /*step 2*/
   pthread_attr_setdetachstate(&attr, PTHREAD_CREATE_JOINABLE); /*step 3*/
   ...
   pthread_attr_destroy(&attr); /*step 4*/
   for(t=0; t<NUM_THREADS; t++) {
